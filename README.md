...
const MarketDecoderTH = () => {
  ...
  useEffect(() => {
    const envKey = ""; // Set API Key here if deploying
  ...
  const analyzeNews = async () => {
    ...
    try {
      // System prompt updated: Terms in English, Definitions in Thai
      const systemPrompt = `
        ...
        2. "vocabulary": An array of objects { "term": "...", "definition": "..." }. 
           - "term": Keep the financial term in ENGLISH (e.g., "Yield Curve", "Inflation", "Quantitative Easing").
        ...
        Ensure the tone is educational, objective, and easy to understand.
      `;
...
export default MarketDecoderTH;
